...
class MilvusRetriever(BaseRetriever):
    ...
    def __init__(self, docs: Optional[Sequence[Document]] = None, rebuild: bool = False, **kwargs):
    ...
    def _get_relevant_documents(
        ...
        """LangChain BaseRetriever 标准接口"""
        topk = self.search_kwargs.get("k", 10)
        return self.retrieve_topk(query, topk=topk)
