...
| 模型 | Exact Match | Token F1 | ROUGE-L | No Answer Accuracy | 可回答样本平均 Token F1 | 拒答样本平均 Token F1 | missed_no_answer_count |
|---|---:|---:|---:|---:|---:|---:|---:|
| 基础模型 `Qwen3-8B` | 0.0000 | 0.1064 | 0.0832 | 0.8931 | 0.1173 | 0.0149 | 42 |
| 微调后 `Qwen3-8B + LoRA` | 0.0916 | 0.4265 | 0.3690 | 0.9847 | 0.3750 | 0.8573 | 6 |
...
- `No Answer Accuracy` 从 0.8931 提升到 0.9847，说明微调后模型在越域问题上更稳定地学会输出“无答案”
